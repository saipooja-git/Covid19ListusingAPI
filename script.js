...
const covdata = function(){
    fetch(`https://covid-19-data.p.rapidapi.com/country/code?format=json&code=IN`, {
        method: 'GET',
        headers: {
            'X-RapidAPI-Host': 'covid-19-data.p.rapidapi.com',
            'X-RapidAPI-Key': 'c4708bdf4dmsh226ae5f06c82ac5p16fb25jsncd7f97a49dfe'
        }
    }).then(res=>
    {
    ...
    {
        console.log(`COVID-19 Data for ${data[0].country}`);
        renderCountry(data);
